...
public class SupTradeChartBuilder extends JFrame {
    ...
    String title;
    static List<ViewSupTrade> list;//数据集合
    ...
    private static JFreeChart createJFreeChart(PieDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createPieChart("供应商交易统计", dataset, true, true, false);

        //设置标题字体,为了防止中文乱码
        chart.setTitle(new TextTitle("供应商交易统计", new Font("黑体", Font.ITALIC, 22)));
