 ...
 * @author LIUYIYU
 */
public class SelReturnInfoFrame extends javax.swing.JInternalFrame {

    SelreturnBiz srtbiz = new SelreturnBizImpl();
    ExportExcelSelreturn exportsrt = new ExportExcelSelreturn();
    /**
     * Creates new form SelReturnInfoFrame
     */
    public SelReturnInfoFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblReturn.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "退货编号", "商品名称", "商品型号", "客户姓名", "退货单价", "退货数量", "退货时间"
            }
        ));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(txtCondition, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnQueryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQueryActionPerformed
        ...
        //2 通过查询业务获得商品集合
        List<ViewSelReturn> list = srtbiz.findByCondition(start, end, condition);
        //3 显示在表格
        showOnTable(list);
    ...
    private void btnExportExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportExcelActionPerformed
        ...
        exportsrt.printSelreturn(list, file); //st是要导出到excel的数据集合，来自于数据库查询
    }//GEN-LAST:event_btnExportExcelActionPerformed
    private void showOnTable(List<ViewSelReturn> list) {
        ...
        // 3.显示数据
        for (ViewSelReturn p : list) {
            Vector vt = new Vector();
            vt.add(p.getSrtid());
            vt.add(p.getProname());
            vt.add(p.getType());
            vt.add(p.getCusname());
            vt.add(p.getSrtprice());
            vt.add(p.getSrtcount());
            vt.add(p.getSrtdate());
            dtm.addRow(vt);
        }
    }
