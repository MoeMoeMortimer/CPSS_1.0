 ...
 */
public class ExportEmpExcel {
    //打印商品销售信息
    public static void printSale(List<ViewEmpsel> list,File file){
          //1 ============设定表列名
            String empid = "销售员编号";
            String ename= "销售员姓名";
            String selcount = "销售总数量";
           ...
           try {
                ...
                WritableFont font1 = new WritableFont(WritableFont.TIMES, 13, WritableFont.NO_BOLD, false, UnderlineStyle.NO_UNDERLINE, Colour.BLACK, ScriptStyle.NORMAL_SCRIPT);
               ...
               Label labelSelcount = new Label(2, 0, selcount, format);
               Label labelTotalprice= new Label(3, 0, totalprice, format);
               //添加列名 才添加进去
              ...
              //4 =====================取出List集合中的的内容，放到Excel中
               ...
               for (int i = 0; i < row; i++) {
                      ...
                      Label selcount1 = new Label(2, i+1, list.get(i).getTotalcount().toString(), format1);
                      Label totalprice1 = new Label(3, i+1, list.get(i).getTotalprice().toString(), format1);                      
                        //添加每一行内容
